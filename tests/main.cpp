...
TEST_CASE( "preprocess empty" ) {
	std::string res =
#	include <tests/templates/empty.htmltc>
	;
...
TEST_CASE( "preprocess static" ) {
	std::string res =
#	include <tests/templates/static.htmltc>
	;
...
TEST_CASE( "preprocess simple string variable" ) {
	...
	std::string res =
#	include <tests/templates/one_var.htmltc>
	;
...
TEST_CASE( "preprocess two string variables without space between them" ) {
	...
	std::string res =
#	include <tests/templates/two_vars.htmltc>
	;
...
TEST_CASE( "preprocess char as int variable" ) {
	...
	std::string res =
#	include <tests/templates/char_as_int_var.htmltc>
	;
...
TEST_CASE( "preprocess int variable" ) {
	...
	std::string res =
#	include <tests/templates/int_var.htmltc>
	;
...
TEST_CASE( "preprocess float variable" ) {
	...
	std::string res =
#	include <tests/templates/float_var.htmltc>
	;
...
TEST_CASE( "preprocess std::array and std::vector" ) {
	...
	std::string res =
#	include <tests/templates/array_vector.htmltc>
	;
...
TEST_CASE( "preprocess formatted floats" ) {
	...
	std::string res =
#	include <tests/templates/formatted_floats.htmltc>
	;
